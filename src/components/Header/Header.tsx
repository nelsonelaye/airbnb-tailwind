...
const Header = () => {
  return (
    <header className="flex justify-between items-center border-y-2 h-20 px-10 text-base font-semibold">
      ...
      />
      <div className="flex items-center border px-1 py-2 rounded-3xl cursor-pointer hover:border-b-2">
        <div className="mx-1.5">
          <span className="px-4 cursor-pointer">Anywhere</span>

          <span className="px-4 border-x-2 cursor-pointer">Any week</span>
      ...
      <div className="flex items-center">
        ...
        <div className="flex items-center py-1 px-2 border-2 rounded-3xl ml-2  hover:border-b-2 cursor-pointer">
          ...
          <div className="relative bg-fade p-1.5 rounded-full">
            <div
              ...
              bg-brand-color"
            ></div>
            <FaUser color="#fff" fontSize="20px" className="cursor-pointer" />
          </div>
        </div>
      </div>
    </header>
